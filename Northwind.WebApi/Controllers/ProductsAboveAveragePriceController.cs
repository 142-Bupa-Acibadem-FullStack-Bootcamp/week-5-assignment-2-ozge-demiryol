...
namespace Northwind.WebApi.Controllers
{
    ...
    {
        IProductsAboveAveragePriceService priceService;
        public ProductsAboveAveragePriceController(IProductsAboveAveragePriceService priceService): base(priceService)
        {

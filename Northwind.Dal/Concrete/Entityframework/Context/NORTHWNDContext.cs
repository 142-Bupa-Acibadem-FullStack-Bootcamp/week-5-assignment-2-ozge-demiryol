...
namespace Northwind.Dal.Concrete.Entityframework.Context
{
    public partial class NORTHWNDContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //lazy loading kullanma, parantez icindeki parametre default olarak true gelir
                ...
                //optionsBuilder.UseSqlServer("Server=DESKTOP-2UPC2IK\\SQLEXPRESS;Database=NORTHWND;Trusted_Connection=True;");
                optionsBuilder.UseSqlServer(configuration.GetConnectionString("SqlServer"));
            }*/

            //Lazy loading configuration kisminda aktiflestirilir.
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.UserId).HasColumnName("UserID"); //HasColumnName Kolon adini degistirmeye yariyor.
            });
